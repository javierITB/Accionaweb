  ...
  useEffect(() => {
    const fetchCompanyLogo = async () => {
      try {
        ...
        const userResponse = await fetch(`https://https://back-acciona.vercel.app/api/auth/full/${userMail}`);
        if (!userResponse.ok) {
        ...
        const companiesResponse = await fetch(`https://https://back-acciona.vercel.app/api/auth/empresas/todas`);
