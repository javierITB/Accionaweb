    ...
    useEffect(() => {
        ...
        const loadDocument = async () => {
            ...
            try {
                ...
                else if (cleanDocType === 'docx' || cleanDocType === 'doc') {
                    const response = await safeFetch(documentUrl);
        ...
        switch (cleanDocType) {
            ...
            case 'csv':
                return (
                    <div className="h-full overflow-auto bg-gray-200 p-4 md:p-8">
                        <div
                            className="mx-auto bg-white shadow-2xl p-4 md:p-8 inline-block min-w-full"
            ...
            case 'webp':
                return (
                    <div className="h-full flex flex-col items-center justify-center bg-gray-100 overflow-auto p-4 dark:bg-gray-800">
                        <img
                            src={documentUrl}
                            alt="Vista previa"
                ...
                <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white dark:bg-black rounded-lg sm:rounded-xl shadow-xl flex flex-col w-[98vw] h-[95vh] sm:w-[95vw] sm:h-[90vh] max-w-6xl mx-2 sm:mx-4 overflow-hidden">
                    ...
                    <div className="flex justify-between items-center px-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-black shrink-0">
                        ...
                        <div className="flex items-center space-x-6 min-w-0 flex-1 h-12">
                            <span className="flex items-center space-x-2 px-1 text-gray-800 dark:text-gray-200">
                    ...
                    {/* Content Area */}
                    <div className={`flex-1 ${documentType === 'pdf' ? 'overflow-hidden' : 'overflow-auto'} bg-gray-50 dark:bg-gray-900 relative`}>
