...
const NotificationsCard = ({ user, onUnreadChange }) => {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        const res = await fetch(`https://accionaapi.vercel.app/api/noti/${user}`);
  ...
  const handleDeleteNotifications = async () => {
    try {
      ...
      const res = await fetch(`https://accionaapi.vercel.app/api/noti/${mail}`, {
        method: "DELETE",
        headers: {
  ...
  const handleDeleteNotification = async (id) => {
    try {
      ...
      const res = await fetch(`https://accionaapi.vercel.app/api/noti/${mail}/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const markAllAsRead = async () => {
    try {
      ...
      const res = await fetch(`https://accionaapi.vercel.app/api/noti/${mail}/leido-todas`, {
        method: "PUT",
