...
const FormCenter = ({ userPermissions = [] }) => {
   ...
   return (
      <div className="min-h-screen bg-background text-foreground">
         ...
         <main className={`transition-all duration-300 ${mainMarginClass} pt-24 lg:pt-20 pb-12`}>
               ...
               <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                     ...
                     {permisos.create_formularios && (
                        <Button variant="default" size="sm" iconName="Plus" onClick={() => navigate("/form-builder")}>
                           Crear Formulario
                        </Button>
                     )}
                  </div>
