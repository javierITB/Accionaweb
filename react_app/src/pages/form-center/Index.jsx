               ...
               <div className="space-y-3 lg:space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between items-center text-center md:items-stretch md:text-left">
                     ...
                     <div className="flex items-center space-x-2 lg:space-x-3 flex-wrap justify-center md:justify-end">
                        ...
                        {permisos.create_formularios && (<Button
                           variant="default"
                           size="sm"
                           iconName="Plus"
                           iconPosition="left"
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                     ...
                     <div
                        className={`bg-card border rounded-lg p-3 sm:p-4 cursor-pointer transition-all duration-300
                  ...
                  {isLoading ? (
                     ...
                     <div className="space-y-3 lg:space-y-4">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                           ...
                           {searchQuery && (
                              <div className="text-sm text-muted-foreground">Resultados de "{searchQuery}"</div>
                           )}
                        </div>
