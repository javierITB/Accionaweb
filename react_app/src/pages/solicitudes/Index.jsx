               ...
               <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                  <div className="mb-4 md:mb-0">
                     <h1 className="text-2xl md:text-3xl font-bold text-foreground mt-4">
                        Inyección de Solicitud (Administrativo)
                     </h1>
                     ...
                     <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                           <label className="text-sm font-medium text-foreground">
                              Asunto (Se mapea a: "{Q_NOMBRE_TRABAJADOR_TITLE}")
                           </label>
                           <Input
                              name="asunto"
                        ...
                        <div className="space-y-2">
                           <label className="text-sm font-medium text-foreground">
                              Mensaje (Se guarda como campo de trazabilidad)
                           </label>
                           <Textarea
                              name="mensaje"
                        ...
                        <div className="space-y-2">
                           <label className="text-sm font-medium text-foreground">
                              Adjuntar Archivos (Se mapea a: "{Q_DOCUMENTO_ADJUNTO_TITLE}")
                           </label>
                           <div
                           ...
                           >
                              ...
                              <p className="text-sm text-muted-foreground">
                                 <span className="font-semibold text-primary">Haz clic para subir</span> o arrastra y
                                 suelta
                              </p>
