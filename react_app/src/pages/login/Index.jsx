            ...
            {isLocked && (
               <div className="mb-4 p-4 bg-amber-50 border border-amber-300 text-amber-800 rounded-xl text-sm flex items-center space-x-3">
                  ...
                  <div>
                     ...
                     <p>
                        Demasiados intentos fallidos. Intenta de nuevo en <strong>{lockoutTime}s</strong>.
                     </p>
                  </div>
               </div>
            )}
            ...
            {view === "login" && (
               <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="text-right">
                     <a
                        href="/recuperacion"
                        className="text-sm font-medium text-orange-600 hover:text-orange-500 transition duration-150"
                     >
            ...
            {view === "2fa" && (
               <form onSubmit={handle2FASubmit} className="space-y-6">
                  <div className="p-3 bg-orange-50 border border-orange-300 text-orange-700 rounded-xl text-sm font-medium flex items-center space-x-2">
                     ...
                     <span>
                        Se requiere un código. Revisa <strong className="font-semibold">{email}</strong>.
                     </span>
                  </div>
