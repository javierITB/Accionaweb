   ...
   const fetchFormsAndTemplates = async () => {
      try {
         ...
         const templatesWithFormInfo = templatesData.map((template) => {
            const associatedForm = formsData.find(
               (form) => form.plantillaId === template._id || form._id === template.formId,
            );
            return {
               ...template,
   ...
   return (
      <div className="space-y-8">
         ...
         <div className="flex items-center space-x-3">
            ...
            <div>
               <h3 className="text-lg font-semibold text-foreground">Selección de Plantilla Base</h3>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
               <div className="bg-card border border-border rounded-lg p-6 max-w-2xl mx-4 w-full">
                  <div className="flex items-center space-x-3 mb-4">
                     ...
                     <h3 className="text-lg font-semibold">Crear Plantilla para: {selectedFormForTemplate.title}</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                     ...
                     <div className="border-2 border-border rounded-lg p-4">
                        ...
                        {permisos.copiar ? (
                           ...
                           <p className="text-xs font-bold text-red-500 italic uppercase tracking-tight">
                              Acceso Restringido para duplicar
                           </p>
                        )}
                     </div>
                  </div>
