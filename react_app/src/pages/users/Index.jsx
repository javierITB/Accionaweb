...
const FormReg = () => {
  ...
  useEffect(() => {
    const fetchEmpresas = async () => {
      try {
        ...
        const response = await fetch('https://https://back-acciona.vercel.app/api/auth/empresas/todas');
  ...
  const fetchUsers = async () => {
    try {
      const res = await fetch(`https://https://back-acciona.vercel.app/api/auth/`);
  ...
  const handleSave = async () => {
    ...
    const url = isUpdating
      ? `https://https://back-acciona.vercel.app/api/auth/users/${editingUser._id}`
      : 'https://https://back-acciona.vercel.app/api/auth/register';
    ...
    try {
      ...
      if (!isUpdating) {
        ...
        const mailResponse = await fetch('https://https://back-acciona.vercel.app/api/mail/send', {
          method: 'POST',
  ...
  const handleRemoveUser = async (userId) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(`https://https://back-acciona.vercel.app/api/auth/users/${userId}`, {
        method: 'DELETE',
      });
