...
const CompanyReg = () => {
  ...
  const handleEditEmpresa = async (empresaId) => {
    ...
    try {
      const response = await fetch(`https://https://back-acciona.vercel.app/api/auth/empresas/${empresaId}`);
      if (!response.ok) {
  ...
  const handleRegisterEmpresa = async () => {
    ...
    try {
      ...
      const url = isUpdating
        ? `https://https://back-acciona.vercel.app/api/auth/empresas/${editingEmpresa._id}`
        : 'https://https://back-acciona.vercel.app/api/auth/empresas/register';
